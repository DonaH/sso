      ...
      <div class="row">
          <!-- Webstore Login Form -->
            <div class="panel_base" id="webstore-login" style="display:none;">
                ...
                <form class="form-signin panel" id="login" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                  <div><a id="dashboard" href="#" data-toggle="tooltip" title="For Accessing Training Modules: Course Library | Performance Tracker | CaseBuilder">SonoSim Dashboard</a></div>
                  <br />
                  <div class="seperator">
                      <span style="font-size: 16px; color: #8ccedd; background-color: #377BB5; padding: 0 10px;">Or</span>
                  </div>
                  ...
                  <p style="text-align:left">
                    <span><input type="checkbox" value="remember"> Remember me</span>
                      <span style="float:right;" ><a style="color:#666666;" href="https://dev.sonosim.com/wp-content/sso/lostpw.php"<h5>Lost your password?</h5></a></span>
                  </p>
                  <input type="submit" class="btn btn-lg btn-primary btn-block" value="Log in" data-toggle="tooltip" title="For Customers Who Purchased Personal Solutions" />
